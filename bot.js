...
function startListenMess(message) { // обработака всех сообщений // message.channel.type // text dm
	...
	for (key in comands) {
		...
		// в личке проверять права не нужно (хз нужно ли права на отправку смс)
		if (type != 'dm') { // еще групповые dm могут быть ??
